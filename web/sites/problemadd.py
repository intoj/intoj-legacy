...
def Submit(req):
	...
	if req['id'] != '':
		...
		db.Execute("INSERT INTO problems VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s);",(req['id'],req['title'],req['description'],req['input_format'],req['output_format'],\
		...
		db.Execute("INSERT INTO problems VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s);",(id,req['title'],req['description'],req['input_format'],req['output_format'],\
		req['example'],req['limit_and_hint'],req['time_limit'],req['memory_limit']))
